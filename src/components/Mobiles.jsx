...
function Mobiles() {
  return (
    <div className='mobile-main'>
        <Mobile className={'mobile1'} height={'512'} width = {'264'} borderRadius ={'10'} background ={'rgb(191, 191, 191)'} />
        <Mobile className={'mobile1'} height={'564'} width = {'290'} borderRadius ={'10'} background ={'rgb(191, 191, 191)'} />
        <Mobile className={'mobile1'} height={'512'} width = {'264'} borderRadius ={'10'} background ={'rgb(191, 191, 191)'} />
